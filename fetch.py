#!/usr/bin/env python3
"""
Recupero codici sconto Trainline da shopilo.it
Sursa: https://shopilo.it/negozi/thetrainline.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/thetrainline.com"
STORE_NAME = "Trainline"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Trainline da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-trainline)"
    }
    try:
